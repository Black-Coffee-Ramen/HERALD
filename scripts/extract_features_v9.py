"""
scripts/extract_features_v9.py

Extracts features for all 213,495 domains in HERALD v9.
...
def load_tranco_lookup():
    ...
    if not os.path.exists(zip_path):
        print(f"WARNING: {zip_path} not found. Tranco features will be -1.")
        return {}
...
def main():
    print("=" * 60)
    print("HERALD v9 Dataset Feature Extraction (213k Domains)")
    print("=" * 60)
    
    input_path = 'data/processed/full_dataset_v9_raw.csv'
    output_path = 'data/processed/full_features_v9.csv'
